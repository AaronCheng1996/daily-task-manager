  ...
  <div class="animate-fade-in">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      ...
      <div class="stat-card-primary animate-slide-up">
        <div class="flex items-center justify-between p-6">
          <div>
            <p class="text-white/80 dark:text-gray-200 text-sm font-medium mb-2">{{ $t('tasks.totalTasks') }}</p>
      ...
      <div class="stat-card-success animate-slide-up" style="animation-delay: 0.1s;">
        <div class="flex items-center justify-between p-6">
          <div>
            <p class="text-white/80 dark:text-gray-200 text-sm font-medium mb-2">Completed</p>
      ...
      <div class="stat-card-warning animate-slide-up" style="animation-delay: 0.2s;">
        <div class="flex items-center justify-between p-6">
          <div>
            <p class="text-white/80 dark:text-gray-200 text-sm font-medium mb-2">{{ $t('tasks.inProgress') }}</p>
            <p class="text-3xl font-bold text-white">{{ taskStore.incompleteTasks.length }}</p>
            <p class="text-white/60 text-xs">{{ taskStore.incompleteTasks.length }} {{ $t('tasks.remaining') }}</p>
          </div>
          <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="stat-card-info animate-slide-up" style="animation-delay: 0.3s;">
        <div class="p-6">
          <div class="flex items-center justify-between mb-4">
            <p class="text-white/80 dark:text-gray-200 text-sm font-medium">{{ $t('tasks.taskTypes') }}</p>
          ...
          <div class="space-y-2">
            <div class="flex items-center justify-between text-sm">
              <span class="text-white/70 dark:text-gray-200">{{ $t('tasks.todo') }}</span>
              <span class="text-white font-medium">{{ tasksByType.todo }}</span>
            </div>
            <div class="flex items-center justify-between text-sm">
              <span class="text-white/70 dark:text-gray-200">{{ $t('tasks.habits') }}</span>
              <span class="text-white font-medium">{{ tasksByType.habit }}</span>
            </div>
            <div class="flex items-center justify-between text-sm">
              <span class="text-white/70 dark:text-gray-200">{{ $t('tasks.daily') }}</span>
              <span class="text-white font-medium">{{ tasksByType.daily }}</span>
            </div>
            <div class="flex items-center justify-between text-sm">
              <span class="text-white/70 dark:text-gray-200">{{ $t('tasks.longterms') }}</span>
        ...
        <div class="p-6">
          ...
          <div class="mb-6">
            <div class="flex items-center justify-between mb-2">
              <span class="text-sm font-medium text-gray-700 dark:text-gray-200">{{ $t('tasks.overallCompletion') }}</span>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div class="text-center">
              ...
              <p class="text-sm font-medium text-gray-600 dark:text-gray-200">{{ $t('tasks.todos') }}</p>
            ...
            <div class="text-center">
              ...
              <p class="text-sm font-medium text-gray-600 dark:text-gray-200">{{ $t('tasks.habits') }}</p>
            ...
            <div class="text-center">
              ...
              <p class="text-sm font-medium text-gray-600 dark:text-gray-200">{{ $t('tasks.daily') }}</p>
            ...
            <div class="text-center">
              ...
              <p class="text-sm font-medium text-gray-600 dark:text-gray-200">{{ $t('tasks.longterms') }}</p>
      ...
      <div class="card-gradient animate-slide-up" style="animation-delay: 0.5s;">
        <div class="p-6">
          ...
          <div class="mt-6 p-4 bg-gray-50 rounded-lg">
            <h4 class="font-medium text-gray-800 dark:text-gray-200 mb-3">{{ $t('tasks.todaysSummary') }}</h4>
            <div class="space-y-2 text-sm">
              <div class="flex items-center justify-between">
                <span class="text-gray-600 dark:text-gray-200">{{ $t('tasks.completedToday') }}</span>
                <span class="font-medium text-green-600">{{ taskStore.completedTasks.length }}</span>
              </div>
              <div class="flex items-center justify-between">
                <span class="text-gray-600 dark:text-gray-200">{{ $t('tasks.remaining') }}</span>
              ...
              <div v-if="overdueTasks > 0" class="flex items-center justify-between">
                <span class="text-gray-600 dark:text-gray-200">{{ $t('tasks.overdue') }}</span>
    ...
    <div class="card-gradient animate-slide-up" style="animation-delay: 0.4s;">
      ...
      <div v-if="taskStore.tasks.length === 0" class="text-center py-12">
        ...
        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-200 mb-2">{{ $t('tasks.noTasksYet') }}</h3>
        <p class="text-gray-500 dark:text-gray-200 mb-6">{{ $t('tasks.noTasks') }}</p>
        <button
          @click="showCreateTask = true"
          class="btn-primary inline-flex items-center"
        >
      ...
      <div v-else class="space-y-4">
        ...
        <div v-if="taskStore.tasks.length > 5" class="pt-4 border-t border-gray-200">
          ...
          >
            {{ $t('tasks.viewMoreTasks', { count: taskStore.tasks.length - 5 }) }}
          </RouterLink>
        </div>
      </div>
    </div>
